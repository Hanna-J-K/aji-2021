...
function OrderEditingModal(props: Order) {
    ...
    return (
    	<>
            <IconButton onClick={onOpen} variant="magic" m={5} color="yellow.800" aria-label="edit" icon={<EditIcon />} />
					...
					<Flex direction="column" >
						...
						<ModalBody>
							<Box borderRadius="lg" boxShadow="0 1px 3px 0 #ffffff" p={5}>
								<Box color="white"> Order placement date: {orderPlaceDate} </Box>
								...
								<Box color="white" fontWeight="semibold"> 
									...
									<Menu>
                                        <MenuButton changeOrderStatus={changeOrderStatus} as={Button} variant="magic" rightIcon={<ChevronDownIcon />}>
                                            Edit status
                                        </MenuButton>
                                        <MenuList
                                            bg="blue.500"
                                            ...
                                            borderRadius="xl"
                                            >
                                            <MenuItem _hover= {{ backgroundColor: "pink.500", color: "white"}}>Not confirmed</MenuItem>
                                            <MenuItem _hover= {{ backgroundColor: "pink.500", color: "white"}}>Confirmed</MenuItem>
                                            <MenuItem _hover= {{ backgroundColor: "pink.500", color: "white"}}>Completed</MenuItem>
                                            <MenuItem _hover= {{ backgroundColor: "pink.500", color: "white"}}>Cancelled</MenuItem>
                                        </MenuList>
                                    </Menu>
								</Box>
							</Box>
