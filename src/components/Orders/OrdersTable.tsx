            ...
            <Accordion defaultIndex={[0]} allowMultiple>
                <AccordionItem>
                    ...
                    <AccordionPanel pb={4}>
                            ...
                            <Center>
                                <OrderEditingModal />
                                <IconButton variant="magic" m={5} color="yellow.800" aria-label="edit" icon={<DeleteIcon />} />
                            </Center>
                ...
                <AccordionItem>
                    ...
                    <AccordionPanel pb={4}>
                            ...
                            <Center>
                                <IconButton variant="magic" m={5} color="yellow.800" aria-label="edit" icon={<EditIcon />} />
                                <IconButton variant="magic" m={5} color="yellow.800" aria-label="edit" icon={<DeleteIcon />} />
                            </Center>
                    </AccordionPanel>
                </AccordionItem>
